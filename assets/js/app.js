...
(function() {
  var Configuration, Controller, DigitalClock, REGISTER, Station, StationsCollection, Train, TrainCollection, activation, app, bb, emptyList, init, mainView, pause, resume, selector, serviceContainers, start, stop, trainItem, trainList, webapp, zlog,
  ...
  if (window.WinJS) {
    ...
    app.onactivated = function(args) {
      if (args.detail.kind === activation.ActivationKind.launch) {
        ...
        return args.setPromise(WinJS.UI.processAll());
      }
    };
  ...
  Controller = (function(_super) {
    ...
    Controller.prototype.initialize = function() {
      if (localStorage.configuration) {
        this.config = new Configuration(JSON.parse(localStorage.configuration));
      } else {
    ...
    Controller.prototype.resume = function() {
      if (localStorage.from) {
        if (localStorage.to && localStorage.to !== 'null') {
          this.navigate("trains/from/" + localStorage.from + "/to/" + localStorage.to);
        } else if (localStorage.from && localStorage.from !== 'null') {
    ...
    Controller.prototype.saveConfig = function() {
      return localStorage.configuration = JSON.stringify(this.config.toJSON());
    };
  ...
  TrainCollection = (function(_super) {
    ...
    TrainCollection.prototype.url = function() {
      if (this.to !== void 0 && this.to !== null && this.to !== 'NULL') {
        return "https://www.riper.fr/api/stif/trains/from/" + this.from + "/to/" + this.to + "?" + (uniqid());
      } else {
        return "https://www.riper.fr/api/stif/trains/from/" + this.from + "?" + (uniqid());
      }
    };
  ...
  mainView = (function(_super) {
    ...
    mainView.prototype.updateTheme = function() {
    ...
    mainView.prototype.render = function() {
      ...
      return $('.themeSelector input[type="checkbox"]').bind('change', this.updateTheme);
    };
  ...
  trainItem = (function(_super) {
    ...
    trainItem.prototype.remove = function() {
      var _this = this;
      this.$el.addClass('removed');
      this.removed = true;
      this.render();
      return setTimeout(function() {
        _this.$el.addClass('realy');
        return setTimeout(function() {
